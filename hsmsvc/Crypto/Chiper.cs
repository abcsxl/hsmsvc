...
namespace HSMSvc.Crypto
{
    class Cipher
    {
        ...
        internal static byte[] byteConvert32Bytes(BigInteger n)
        {
            byte[] tmpd = null;
            if (n == null)
            {
        ...
        internal ECPoint Init_enc(SM2Core sm2, ECPoint userKey)
        {
        ...
        internal void Init_dec(BigInteger userD, ECPoint c1)
        {
